...
Réponds UNIQUEMENT avec un tableau JSON strict sans aucun texte ni balise autour, comme ceci :
[
  {
  ...
  // Utilisation directe de l'API standard REST v1beta
  ...
  try {
    ...
    console.error(err);
    if (recipesList) recipesList.innerHTML = "<p style='font-size: 0.85rem; color: #d9534f;'>Erreur lors de la réponse de l'IA.</p>";
  }
}
